...
Antes de continuar, dejame mostrarte un comoando mas de Cargo: `run`. `cargo run` es una especie de `cargo build`, pero con la diferencia de que tambien ejecuta el binario producido. Pruebalo: 
