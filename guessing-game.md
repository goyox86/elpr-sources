...
Pruebalo. Pero espera, no acabamos de agregar un ciclo infinito? Sip. Recuerdas nuestra discusión acerca de `parse()`? Si damos una respuesta no numérica, retornaremos y finalizaremos la ejecución.
