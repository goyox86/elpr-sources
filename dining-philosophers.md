...
> tiempo pensando; pero cuando se sintieran con hambre, ellos se dirigieran a el comedor tomaran el tenedor que estaba a su izquierda y lo sumieran en el espagueti. Pero tal era naturaleza enredada del espagueti que un segundo teneros era requerido para llevarlo a la boca. El filosofo por ende tenia que tambien tomar el tenedor a su derecha. Cuando terminaban debian colocar los filosofos debian bajar sus tenedres, levantarse de la silla y continuar pensando. Por supuesto, un tenedir puede ser usado por un solo filosofo a la vez. Si otro filosofo lo desea, tiene que esperar hasta que el tenedor este disonible nuevamente.
